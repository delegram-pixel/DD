...
export default function EditableProfilePage() {
  ...
  const handleArrayInputChange = (parent, field, index, value) => {
    setEditForm(prev => ({
      ...prev,
      [parent]: {
        ...prev[parent],
  ...
  const addArrayItem = (parent, field, defaultValue = "") => {
    setEditForm(prev => ({
      ...prev,
      [parent]: {
        ...prev[parent],
  ...
  const addPublicationItem = () => {
    setEditForm(prev => ({
      ...
      achievements: {
        ...prev.achievements,
        publications: [...prev.achievements.publications, { title: "", description: "" }]
      }
    }));
  };
  ...
  const currentData = isEditing ? editForm : user;
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                      {editForm.achievements?.recognition?.map((item, index) => (
                        <div key={index} className="flex gap-2">
                          <Input
                            value={item}
